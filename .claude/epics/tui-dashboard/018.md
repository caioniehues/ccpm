...
- [ ] Cross-compilation for Linux, macOS (Intel + ARM), Windows
- [ ] Binary size optimized (< 15MB)
- [ ] Version info embedded in binary
- [ ] Makefile for common build tasks
- [ ] GitHub Actions workflow for releases
- [ ] Installation integrated with CCPM installer
- [ ] `ccpm-tui --version` shows version info
