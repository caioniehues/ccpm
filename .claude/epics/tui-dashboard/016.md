...
- [x] Minimum size: 80 columns × 24 rows
- [x] "Terminal too small" message when below minimum
- [x] Small (80-99 cols): Single column, abbreviated labels
- [x] Medium (100-119 cols): Full labels, standard progress bars
- [x] Large (120+ cols): Side-by-side panels
- [x] Extra tall (40+ rows): Expanded viewports, more items visible
- [x] Window resize updates layout immediately
