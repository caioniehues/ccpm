...
- [ ] Progress bar gradient animation on updates
- [ ] Cursor blink animation (530ms)
- [ ] In-progress task pulse animation
- [ ] Sync indicator rotation
- [ ] Success flash on completion (green highlight, 300ms)
- [ ] Error shake on failures (horizontal jitter)
- [ ] Notification toasts (success, error, warning, info)
- [ ] Toast auto-dismiss (3s for success/info, 5s for warning)
